...
class Datos {
  ...
  public:
    ...
    int ** traslado = (int *[]) { /* IN */    (int []) {0, 3, 4, 5, 6, 4, 2, 4, 4, 0},
                                  /* T */     (int []) {3, 0, 1, 2, 2, 1, 2, 1, 1, 3},
                                  /* S */     (int []) {4, 1, 0, 5, 1, 2, 1, 3, 2, 4},
                                  /* B */     (int []) {5, 2, 5, 0, 6, 2, 5, 3, 3, 5},
                                  /* CC */    (int []) {6, 2, 1, 6, 0, 2, 1, 2, 2, 6},
                                  /* P */     (int []) {4, 1, 2, 2, 2, 0, 3, 1, 1, 4},
                                  /* CL */    (int []) {2, 2, 1, 5, 1, 3, 0, 3, 1, 2},
                                  /* D */     (int []) {4, 1, 3, 3, 2, 1, 3, 0, 1, 4},
                                  /* SM */    (int []) {4, 1, 2, 3, 2, 1, 1, 1, 0, 4},
                                  /* OUT */   (int []) {0, 3, 4, 5, 6, 4, 2, 4, 4, 0},
                                };
